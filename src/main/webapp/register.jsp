    ...
    <%@include file="parts/menu.jsp" %>
        ...
        <section class="min-vh-100">
             ...
             <div class="container form-container d-flex justify-content-center mt-5">
                ...
                <div class="row register-container rounded-5 col-lg-12 mt-5">

                    <h1 class="text-center mt-5 mb-3" > S'inscrire</h1>
                    ...
                    <%-- FORMULAIRE INSCRIPTION --%>
                        ...
                        <form method="post" class="register-form mt-5 mx-auto w-75">
                            ...
                            <div class="form-group col-md-6 d-flex flex-column mb-3">
                                <label for="country" class="mb-2 fw-bolder">Pays :</label>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4  d-flex flex-column mx-auto mb-3">
                                    <label for="number" class="mb-2 fw-bolder">Numéro de voie : </label>
                                ...
                                <div class="form-group col-md-8 d-flex flex-column mx-auto mb-3">
                                    <label for="street" class="mb-2 fw-bolder">Rue/voie : </label>
                            ...
                            <%-- Input zipcode   --%>
                                ...
                                <%-- Input password   --%>
                                <div class="form-group col-md-12 d-flex flex-column  mb-3">
                                    <label for="password" class="mb-2 fw-bolder">Mot de passe : </label>
                                    <input class="form-control-lg"  id="password" type="password" name="password"  placeholder="Mot de passe"/>
                                </div>
                                <%-- Input confirm password  --%>
                                <div class="form-group col-md-12 d-flex flex-column mb-3 ">
                                    <label for="confirmPassword" class="mb-2 fw-bolder">Confirmation Mot de passe : </label>
                        ...
                        <p  class="text-center"><span class="fw-bold my-button">Déjà inscrits? </span><a href="http://localhost:8080/login">Se connecter</a></p>
